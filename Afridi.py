...
def ceknet():
    try:
    	os.system('reset')
        print internet
        print '\r\033[37;1m[\x1b[92m+\033[37;1m] \033[37;1mCheck Internet Connection'
        time.sleep(2)
        toolbar_width = 25
        ...
        try:
            ...
            time.sleep(3.5)
            print '\033[37;1m]\033[35;1m ~>\033[31;1m There is no Connection'
            time.sleep(1.5)
            sys.exit()

    except KeyboardInterrupt:
    	time.sleep(3.5)
        exit('\n\033[37;1m[\x1b[92mx\033[37;1m] \033[31;1mProgram Stop\n')

def start():
        try:
            os.system('reset')
            print banner
            email = raw_input('\033[34;1m[\033[37;1m~\033[34;1m]\033[37;1m ID \033[36;1m| \033[37;1mTarget Email\033[36;1m | \033[37;1mHP \033[31;1m: \033[32;1m')
            ...
            print '\033[37;1m[\033[32;1mx\033[37;1m] \033[37;1mMissing wordlist address'
